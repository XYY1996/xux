...
import com.xux.generator.freemarker.framework.util.StringHelper;
import com.xux.generator.freemarker.framework.util.XMLHelper;
...
public class Configuration {
    ...
    private static String CONFIG_FILE_NAME = Global.getResourcePath("configuration.xml");
