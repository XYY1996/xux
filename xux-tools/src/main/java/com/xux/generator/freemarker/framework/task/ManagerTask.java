...
import com.xux.generator.freemarker.framework.handler.impl.ManagerHandler;
...
public class ManagerTask extends AbstractApplicationTask {
    ...
    private static String MANAGERIMPL_FTL = Global.getResourcePath("template/Manager.ftl");
