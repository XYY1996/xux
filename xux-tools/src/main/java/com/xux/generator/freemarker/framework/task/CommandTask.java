...
import com.xux.generator.freemarker.framework.handler.impl.CommandHandler;
...
public class CommandTask extends AbstractApplicationTask {
    ...
    private static String GET_FTL = Global.getResourcePath("template/GetCommand.ftl");
    private static String QUERY_FTL = Global.getResourcePath("template/QueryCommand.ftl");
    private static String _FTL = Global.getResourcePath("template/Command.ftl");
    private static String BATCH_FTL = Global.getResourcePath("template/BatchCommand.ftl");
    private static String LIST_FTL = Global.getResourcePath("template/ListCommand.ftl");
